...
$db['default']['password'] = '';
$db['default']['database'] = 'imran_inventory';
...
/*
 *
 * here is the databse connection*/
...
$db['forum']['password'] = '';
$db['forum']['database'] = '';
$db['forum']['dbdriver'] = 'pdo';
$db['forum']['dbprefix'] = '';
$db['forum']['pconnect'] = TRUE; // changed from TRUE
